  ...
  return (
    ...
    >
      <div className="flex min-h-[520px] flex-col justify-between gap-10 border-b border-portfolio-line p-[clamp(24px,5vw,72px)] sm:min-h-[600px] lg:min-h-[720px] lg:border-b-0 lg:border-r">
        <motion.h1
          className="max-w-[980px] text-balance font-portfolio-heading text-[clamp(3.25rem,12vw,9rem)] font-extrabold leading-[0.94] text-portfolio-ink"
        ...
        <motion.p
          className="max-w-[720px] font-portfolio-mono text-sm leading-[1.8] text-portfolio-muted sm:text-base"
      ...
      <motion.aside
        className="grid content-end gap-4 p-4 sm:grid-cols-[minmax(0,0.85fr)_minmax(240px,1fr)] sm:items-end lg:grid-cols-1"
        initial={{ opacity: 0, y: 20 }}
        animate={{ opacity: 1, y: 0 }}
